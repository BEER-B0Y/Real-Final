                        ...
                        <ul className="navbar-nav ms-auto align-items-center">
                            ...
                            {user ? (
                                <>
                                    ...
                                    <li className="nav-item"><Link className="nav-link text-light" to="/cart">Cart ({cart.reduce((acc, item) => acc + item.Quantity, 0)|| 0})</Link></li>
                                ...
                                <>
                                    ...
                                    <li className="nav-item"><Link className="btn btn-light btn-rounded px-4 ms-3" to="/register">Register</Link></li>
                                </>
                            )}
                        </ul>
                    </div>
